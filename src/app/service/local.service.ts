...
export class LocalService {
  ...
  {
    return[
      {id : 1 , titre : 'un titre', contenu : 'lorem', date_creation : '12/05/2015', categories: ['SF','roman'], email_auteur: 'auteur@gmail.com', estPublie: 'true'},
      {id : 2 , titre : 'un titre', contenu : 'lorem', date_creation : '12/05/2015', categories: ['SF','roman'], email_auteur: 'auteur@gmail.com', estPublie: 'true'},
      {id : 3 , titre : 'un titre', contenu : 'lorem', date_creation : '12/05/2015', categories: ['SF','roman'], email_auteur: 'auteur@gmail.com', estPublie: 'true'},
      {id : 4 , titre : 'un titre', contenu : 'lorem', date_creation : '12/05/2015', categories: ['SF','roman'], email_auteur: 'auteur@gmail.com', estPublie: 'true'},
